...
<div class="container">
    <h1 class="text-center fw-bold">Formulario - Casas</h1>
    <form action="{{route('houses.store')}}" method="post" enctype="multipart/form-data">
        @csrf 

        <div class="mb-3 row">
            <label class="col-sm-2 col-form-label text-rigth">Nombre:</label>
            <div class="col-sm-10">
                <input class="form-control" type="text" name="home" id="">
            </div>
        </div>
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input class="form-control" type="number" name="numDoors" id="">
            </div>
        </div>
        <div class="mb-3 row">
            <label class="col-sm-2 col-form-label text-rigth">Número de Ventanas:</label>
            <div class="col-sm-10">
                <input class="form-control" type="number" name="numWindows" id="">
            </div>
        </div>
        <div class="mb-3 row">
            <label class="col-sm-2 col-form-label text-rigth">Número de Focos:</label>
            <div class="col-sm-10">
                <input class="form-control" type="number" name="numFocus" id="">
            </div>
        </div>
        <div class="mb-3 row">
            <label class="col-sm-2 col-form-label text-rigth">Número de Pisos:</label>
            <div class="col-sm-10">
                <input class="form-control" type="number" name="numFloor" id="">
            </div>
        </div>
        <div class="mb-3 row">
